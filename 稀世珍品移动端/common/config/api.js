...
const api = {
	...
	user_login: ['user/login', METHOD.POST],
	stock_list: ['warehousing/index', METHOD.GET],
	page_goods: ['warehousing/pgoods', METHOD.GET],
	put_stock: ['warehousing/addlog', METHOD.POST],
}
