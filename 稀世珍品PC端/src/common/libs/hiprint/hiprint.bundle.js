									...
									if (this.getFooterFormatter())
										d.find('tfoot').length &&
											d
												...
												.html(
													_table_TableExcelHelper__WEBPACK_IMPORTED_MODULE_6__.a
														.createTableFooter(this.printElementType.columns, this.getData(t), this.options, this.printElementType, t, h)
														.html()
												)
									break
								}
		...
		jQuery,
			...
			(window.hiwebSocket = {
				...
				start: function start() {
					...
					window.WebSocket
						? this.socket ||
						  ((this.socket = io('ws://localhost:17521', {
				...
				return (
					...
					(e.prototype.updateTargetText = function (t, e, n, i) {
						var r = this.getFormatter(),
							...
							p = ''
						p = this.getField()
							? (this.options.getHideTitle() ? '' : e ? e + '：' : '') + (r ? r(e, n, this.options, this._currenttemplateData, t) : n)
					...
					(e.prototype.getTableHtml = function (t, e) {
						...
						return (
							...
							this.printElementType.footerFormatter &&
								('no' == this.options.tableFooterRepeat ||
									('last' == this.options.tableFooterRepeat
										? n.find('tbody').append(X.a.createTableFooter(this.printElementType.columns, t, this.options, this.printElementType, e, t).html())
										: n.append(X.a.createTableFooter(this.printElementType.columns, t, this.options, this.printElementType, e, [])))),
							n
						)
					}),
					(e.prototype.getHtml = function (t, e) {
					...
					(e.prototype.getRowsInSpecificHeight = function (t, e, n, i, r, a) {
						...
						for (var u = e.outerHeight(), d = []; ; ) {
							...
							if (p) {
								this.printElementType.footerFormatter &&
									e.find('tfoot') &&
									e.find('tfoot').html(X.a.createTableFooter(this.printElementType.columns, this.getData(a), this.options, this.printElementType, a, d).html())
								break
							}
						}
									...
									i.referenceElement.isPositionLeftOrRight(e.options.getTop())
										...
										n.forEach(function (t, i) {
											t.referenceElement && (t.referenceElement.endPrintPaperIndex = t.referenceElement.beginPrintPaperIndex + n.length - 1),
												i > 0 &&
													(l.index < p.length - 1 ? (l = p[l.index + 1]) : ((l = s.createNewPage(p.length, l.referenceElement)), p.push(l)),
